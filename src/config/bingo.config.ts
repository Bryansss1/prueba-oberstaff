...
/** Modo REAL: termina 5 min después de cantar los 75. Modo PRUEBA: solo termina con ganador. */
export type BingoGameMode = "REAL" | "PRUEBA";

export const BingoConfig = {
  /** Modo del bingo: REAL (termina tras 75 números + 5 min) o PRUEBA (solo termina con ganador) */
  gameMode: (process.env.BINGO_MODE?.toUpperCase() === "REAL"
    ? "REAL"
    : "PRUEBA") as BingoGameMode,
